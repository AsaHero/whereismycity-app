...
export const enTranslations = {
  ...
  "profile.apiKeyDescription":
    "We only store an encrypted hash of your account password — you remain the only one who knows it. To authenticate API requests, you need a Basic Auth header",
  "profile.apiKeyNote": "Either build that yourself, or use the tool below",
  "profile.apiManual": "Manual:",
  "profile.apiManualDescription":
    "Build a Basic Auth header by Base64‑encoding your username and password",
  "profile.apiManualNote": "for full API usage examples.",
  "profile.generateAuthHeader": "Generate Authorization Header",
  "profile.fields.password": "Password",
  "profile.placeholderPassword": "Enter your account password",
  "profile.placeholderAuth": "[username:password → base64]",
  "profile.copy": "Copy",
...
export const ruTranslations = {
  ...
  "profile.updateSuccess": "Ваш профиль был успешно обновлён.",
  ...
  "profile.fields.password": "Пароль",
  "profile.placeholderPassword": "Введите пароль от аккаунта",
  "profile.placeholderAuth": "[имя_пользователя:пароль → base64]",
  "profile.usernameHelp":
    "Это имя пользователя используется как API ключ для аутентификации ваших запросов.",
  "profile.apiCredentials": "API Учетные данные",
  "profile.apiKey": "Ваш API ключ",
  "profile.apiKeyDescription":
    "Мы храним только зашифрованный хеш вашего пароля — только вы его знаете. Для аутентификации запросов используйте заголовок Basic Auth.",
  "profile.apiKeyNote":
    "Вы можете собрать его вручную или использовать инструмент ниже.",
  "profile.apiManual": "Вручную:",
  "profile.apiManualDescription":
    "Создайте заголовок Basic Auth, закодировав имя пользователя и пароль в Base64",
  "profile.apiManualNote": "для полного примера использования API.",
  "profile.generateAuthHeader": "Сгенерировать заголовок авторизации",
  ...
  "profile.usageDashboardSoon":
    "Подробная статистика использования и аналитическая панель скоро станут доступны.",
